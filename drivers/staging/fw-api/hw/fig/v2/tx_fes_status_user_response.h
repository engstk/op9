...
struct tx_fes_status_user_response {
             ...
             uint32_t fes_transmit_result                                     :  4,
                      reserved_0                                              : 23,
                      overwritten_blackout_window_bitmap                      :  4,
                      mic_overwritten                                         :  1;
             struct   phytx_abort_request_info                                  phytx_abort_request_info_details;
             uint16_t pre_padding_fcs_overwritten                             :  1,
                      reserved_after_struct16                                 : 15;
#else
             uint32_t mic_overwritten                                         :  1,
                      overwritten_blackout_window_bitmap                      :  4,
                      reserved_0                                              : 23,
                      fes_transmit_result                                     :  4;
             uint32_t reserved_after_struct16                                 : 15,
                      pre_padding_fcs_overwritten                             :  1;
             struct   phytx_abort_request_info                                  phytx_abort_request_info_details;
#endif
};
...
#define TX_FES_STATUS_USER_RESPONSE_RESERVED_0_MSB                                  26
#define TX_FES_STATUS_USER_RESPONSE_RESERVED_0_MASK                                 0x0000000007fffff0

#define TX_FES_STATUS_USER_RESPONSE_OVERWRITTEN_BLACKOUT_WINDOW_BITMAP_OFFSET       0x0000000000000000
#define TX_FES_STATUS_USER_RESPONSE_OVERWRITTEN_BLACKOUT_WINDOW_BITMAP_LSB          27
#define TX_FES_STATUS_USER_RESPONSE_OVERWRITTEN_BLACKOUT_WINDOW_BITMAP_MSB          30
#define TX_FES_STATUS_USER_RESPONSE_OVERWRITTEN_BLACKOUT_WINDOW_BITMAP_MASK         0x0000000078000000

#define TX_FES_STATUS_USER_RESPONSE_MIC_OVERWRITTEN_OFFSET                          0x0000000000000000
#define TX_FES_STATUS_USER_RESPONSE_MIC_OVERWRITTEN_LSB                             31
#define TX_FES_STATUS_USER_RESPONSE_MIC_OVERWRITTEN_MSB                             31
#define TX_FES_STATUS_USER_RESPONSE_MIC_OVERWRITTEN_MASK                            0x0000000080000000
...
#define TX_FES_STATUS_USER_RESPONSE_PRE_PADDING_FCS_OVERWRITTEN_OFFSET              0x0000000000000000
#define TX_FES_STATUS_USER_RESPONSE_PRE_PADDING_FCS_OVERWRITTEN_LSB                 48
#define TX_FES_STATUS_USER_RESPONSE_PRE_PADDING_FCS_OVERWRITTEN_MSB                 48
#define TX_FES_STATUS_USER_RESPONSE_PRE_PADDING_FCS_OVERWRITTEN_MASK                0x0001000000000000

#define TX_FES_STATUS_USER_RESPONSE_RESERVED_AFTER_STRUCT16_OFFSET                  0x0000000000000000
#define TX_FES_STATUS_USER_RESPONSE_RESERVED_AFTER_STRUCT16_LSB                     49
#define TX_FES_STATUS_USER_RESPONSE_RESERVED_AFTER_STRUCT16_MSB                     63
#define TX_FES_STATUS_USER_RESPONSE_RESERVED_AFTER_STRUCT16_MASK                    0xfffe000000000000
