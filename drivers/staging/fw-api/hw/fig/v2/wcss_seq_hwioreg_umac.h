...
#define HWIO_UMAC_MXI_R0_MXI_NULL_REMAP_CFG_REG_RMSK                                                        0xf8000007
...
#define HWIO_UMAC_MXI_R0_MXI_TRACKING_TRANSACTION_TIME_n_INI(base,n)                \
                in_dword(HWIO_UMAC_MXI_R0_MXI_TRACKING_TRANSACTION_TIME_n_ADDR(base,n))
...
#define HWIO_UMAC_MXI_R1_MXI_TESTBUS_CAPTURE_n_INI(base,n)                \
                in_dword(HWIO_UMAC_MXI_R1_MXI_TESTBUS_CAPTURE_n_ADDR(base,n))
...
#define HWIO_WBM_R1_TESTBUS_CAPTURE_n_INI(base,n)                \
                in_dword(HWIO_WBM_R1_TESTBUS_CAPTURE_n_ADDR(base,n))
...
#define HWIO_REO_R1_TESTBUS_CAPTURE_n_INI(base,n)                \
                in_dword(HWIO_REO_R1_TESTBUS_CAPTURE_n_ADDR(base,n))
...
#define HWIO_TQM_R1_TESTBUS_CAPTURE_n_INI(base,n)                \
                in_dword(HWIO_TQM_R1_TESTBUS_CAPTURE_n_ADDR(base,n))
...
#define HWIO_UMCMN_R1_RETENTION_SPARE_REGISTER_n_INI(base,n)                \
                in_dword(HWIO_UMCMN_R1_RETENTION_SPARE_REGISTER_n_ADDR(base,n))
...
#define HWIO_TCL_R1_TESTBUS_CAPTURE_n_INI(base,n)                \
                in_dword(HWIO_TCL_R1_TESTBUS_CAPTURE_n_ADDR(base,n))
