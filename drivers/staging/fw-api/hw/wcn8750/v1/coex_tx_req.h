...
#define NUM_OF_DWORDS_COEX_TX_REQ 6

#define NUM_OF_QWORDS_COEX_TX_REQ 3
...
struct coex_tx_req {
             ...
             uint32_t wlan_pkt_type                                           :  4,
                      ...
                      blackout_peek_duration                                  :  8,
                      reserved_3a                                             :  5;
             uint32_t frequency_channel_bonding_mask                          : 16,
                      num_blackout_windows                                    :  8,
                      reserved_4a                                             :  8;
             ...
             uint32_t reserved_3a                                             :  5,
                      ...
                      coex_tx_reason                                          :  2,
                      wlan_pkt_type                                           :  4;
             uint32_t reserved_4a                                             :  8,
                      num_blackout_windows                                    :  8,
                      frequency_channel_bonding_mask                          : 16;
             uint32_t tlv64_padding                                           : 32;
#endif
};
...
#define COEX_TX_REQ_BLACKOUT_DETAILS_EN_OFFSET                                      0x0000000000000008
#define COEX_TX_REQ_BLACKOUT_DETAILS_EN_LSB                                         50
#define COEX_TX_REQ_BLACKOUT_DETAILS_EN_MSB                                         50
#define COEX_TX_REQ_BLACKOUT_DETAILS_EN_MASK                                        0x0004000000000000

#define COEX_TX_REQ_BLACKOUT_PEEK_DURATION_OFFSET                                   0x0000000000000008
#define COEX_TX_REQ_BLACKOUT_PEEK_DURATION_LSB                                      51
#define COEX_TX_REQ_BLACKOUT_PEEK_DURATION_MSB                                      58
#define COEX_TX_REQ_BLACKOUT_PEEK_DURATION_MASK                                     0x07f8000000000000

#define COEX_TX_REQ_RESERVED_3A_OFFSET                                              0x0000000000000008
#define COEX_TX_REQ_RESERVED_3A_LSB                                                 59
#define COEX_TX_REQ_RESERVED_3A_MSB                                                 63
#define COEX_TX_REQ_RESERVED_3A_MASK                                                0xf800000000000000

#define COEX_TX_REQ_FREQUENCY_CHANNEL_BONDING_MASK_OFFSET                           0x0000000000000010
#define COEX_TX_REQ_FREQUENCY_CHANNEL_BONDING_MASK_LSB                              0
#define COEX_TX_REQ_FREQUENCY_CHANNEL_BONDING_MASK_MSB                              15
#define COEX_TX_REQ_FREQUENCY_CHANNEL_BONDING_MASK_MASK                             0x000000000000ffff

#define COEX_TX_REQ_NUM_BLACKOUT_WINDOWS_OFFSET                                     0x0000000000000010
#define COEX_TX_REQ_NUM_BLACKOUT_WINDOWS_LSB                                        16
#define COEX_TX_REQ_NUM_BLACKOUT_WINDOWS_MSB                                        23
#define COEX_TX_REQ_NUM_BLACKOUT_WINDOWS_MASK                                       0x0000000000ff0000

#define COEX_TX_REQ_RESERVED_4A_OFFSET                                              0x0000000000000010
#define COEX_TX_REQ_RESERVED_4A_LSB                                                 24
#define COEX_TX_REQ_RESERVED_4A_MSB                                                 31
#define COEX_TX_REQ_RESERVED_4A_MASK                                                0x00000000ff000000

#define COEX_TX_REQ_TLV64_PADDING_OFFSET                                            0x0000000000000010
#define COEX_TX_REQ_TLV64_PADDING_LSB                                               32
#define COEX_TX_REQ_TLV64_PADDING_MSB                                               63
#define COEX_TX_REQ_TLV64_PADDING_MASK                                              0xffffffff00000000
