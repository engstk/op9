...
};static int DATARMNET2cb9ae589c;static int __init DATARMNET163e93649e(void){pr_info(
...
);}return register_netdevice_notifier(&DATARMNET5fc54f7a13);}static void __exit 
